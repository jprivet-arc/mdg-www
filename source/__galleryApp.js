// From view-source:http://enyojs.com/gallery/source/App.js

var galleryBaseUrl = 'http://enyojs.com/gallery/';
...
enyo.kind({
    ...
    components: [
    {
        ...
        {
            classes: "onyx-toolbar-inline toolbar-inner",
            components: [

            {
                ...
                {
                    kind: "Image",
                    src: galleryBaseUrl + "images/enyo-logo.png",
                    classes: "toolbar-logo"
                }
                ]
                },
            ...
            {
                classes: "toolbar-search",
                components: [

                {
                    kind: "onyx.InputDecorator",
                    classes: "toolbar-search-input-decorator",
                    components: [
...

                    {
                        kind: "Image",
                        name: "clearInput",
                        src: galleryBaseUrl + "images/search-input-search.png",
                        ontap: "clearInput"
                    }
                    ]
                    }
    ...
    clearInput: function() {
        ...
        this.$.clearInput.setSrc(galleryBaseUrl + "images/search-input-search.png");
    },
    handleSearch: function(inSender){
        if (this.widgets) {
            ...
            if (searchValue === "") {
                ...
                this.$.clearInput.setSrc(galleryBaseUrl + "images/search-input-cancel.png");
            }
        }
    },
    fetchGalleryData: function() {
        new enyo.Ajax({
            url: galleryBaseUrl + "gallery_manifest.json"
        })
...
enyo.kind({
    ...
    infoChanged: function() {
        this.inherited(arguments);
        if (this.info) {
            this.$.icon.setSrc(galleryBaseUrl + "gallery_images/" + this.info.name + ".jpg");
        }
    }
});
...
enyo.kind({
    ...
    components: [
    {
        ...
        horizontal: "hidden",
        fit: true,
        classes: "details-scroller",
        components: [

        {
            classes: "details-scroller-content",
            components: [
    ...
    infoChanged: function() {
        ...
        //
        this.$.submissionDate.setNameValue({
            name: "Submission Date",
            value: (i.submissionDate || "Unknown")
            });
        this.$.testedPlatforms.setNameValue({
            name: "Tested Platforms",
            value: (i.testedPlatforms || "Unknown")
            });
        this.$.license.setNameValue({
            name: "License",
            value: i.license
            });
        var dep = [];
        ...
        this.$.dependencies.setNameValue({
            name: "Dependencies",
            value: (dep.length && dep.join(", ") || "None")
            });
    },
    gotoSource: function() {
